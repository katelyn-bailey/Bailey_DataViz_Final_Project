...
ggsave("tpa_max_temps_facet.png")
```
...
ggsave("tpa_max_temps_density.png")
```
...
ggsave("tpa_max_temps_density_facet.png")
```
...
ggsave("tpa_max_temps_ridges_pinks.png")
```
...
ggsave("daily_precipitation_by_month.png")
```
```{r}
...
ggsave("precipitation_scatter_plot.png")
```
...
ggsave("concrete_distributions_1.png")
...
ggsave("concrete_distributions_2.png")
...
ggsave("concrete_distributions_3.png")
```
